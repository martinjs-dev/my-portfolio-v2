const Brands = () => {
  const brandItems = [
    ...
    { id: 18, icon: "assets/img/icons/e-connex-web-marketing.png", name: "e-connex Web Marketing", url: "https://e-connex-web-marketing.tech/" },
    { id: 23, icon: "assets/img/icons/technostatgroup.png", name: "Techno Stat Group", url: "https://technostatgroup.com/" },
    { id: 20, icon: "assets/img/icons/edusign1.png", name: "EduSign", url: "https://edusign.com/" },
    { id: 13, icon: "assets/img/icons/fondationfmm.png", name: "Fondation FMM", url: "https://fondationfmm.com/" },
    { id: 25, icon: "assets/img/icons/lokapart.png", name: "Lokapart", url: "https://lokapart.com/" },
    ...
    { id: 17, icon: "assets/img/icons/escalecrossfit.png", name: "Escale Cross Fit", url: "https://escalecrossfit.com/" },
    { id: 19, icon: "assets/img/icons/awinz.png", name: "Awinz MarketPlace", url: "https://awinz.net/" },
    { id: 4, icon: "assets/img/icons/unilependentif.png", name: "Unile Pendentif", url: "https://unilependentif.fr/" },
    { id: 21, icon: "assets/img/icons/transition-turquoise.png", name: "Transition Turquoise", url: "https://transition-turquoise.fr/" },
    { id: 22, icon: "assets/img/icons/ekfacades.png", name: "EK Façades", url: "https://ekfacades-toulouse.fr/" },
    { id: 24, icon: "assets/img/icons/papilles-sans-gluten.png", name: "Miel du Monde", url: "https://mieldumondefr.com/" },
  ];
  return (
